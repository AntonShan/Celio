...
const convert = require('../utils/typedConversions')
const {decodeSpectralClass} = require('../utils/star')
...
class DATReader extends Reader {
  ...
  read () {
    ...
    while (starNumber < this.starsInFile) {
      ...
      let catalogNumber = uint8ToUint32(this.data.slice(offset + 0, offset + 4))
